...
const SideBar = ({ logo }) => {
  ...
  return (
    ...
    <div className="hidden md:block w-full md:max-w-[27%] ml-0 shadow">
      <div className=" md:min-h-full bg-[#E2E8F0] pt-3 md:pb-7 sticky top-0 m-0  flex flex-row md:flex-col ">
        ...
        >
          ...
          <div  className={`${window.location.pathname === "/" ? "block" : "hidden"} absolute inset-x-0 h-1 top-0 bg-[#174e88d2]`}></div>
        </Link>
        <Link
          to="/index/transfer"
